...
<head>
    <title> Staff Signup | Camera Rentals </title>
</head>
...
<body>
    ...
    <div class="container">
        <div class="jumbotron">
            <h1 class="text-center">Camera Rentals - Registration</h1>
            <br>
            <p class="text-center">Get started by creating an Staff account</p>
        </div>
    </div>
