...
<body>
            ...
            ?>
                ...
                <div class="collapse navbar-collapse navbar-right navbar-main-collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li>
                            <a href="recam/clientlogin.php">Staff</a>
                        </li>
                        <li>
                            <a href="recam/customerlogin.php">Customer</a>
                        </li>
                        <li>
    ...
    <section class="cd-ADUAN">
        ...
        <div class="cd-ADUAN-items">
            ...
            <ul id="chauffeur" class="cd-ADUAN-group">
                <li class="cd-ADUAN-title">
                    <h2>Chauffeur service</h2>
                </li>
                <li>
                    <a class="cd-ADUAN-trigger" href="#0">Do you have meet and greet services?</a>
                    <div class="cd-ADUAN-content">
                ...
                <li>
                    <a class="cd-ADUAN-trigger" href="#0">How can i pay for my chauffeur services?</a>
                    <div class="cd-ADUAN-content">
                        <p>RECAM gladly accepts Mastercard, Visa, and checks. We also PayTm.</p>
                    </div>
                    <!-- cd-ADUAN-content -->
                </li>

                <li>
                    <a class="cd-ADUAN-trigger" href="#0">Is there a fee if i change my Chauffeur services?</a>
                    <div class="cd-ADUAN-content">
