...
<body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top">
    ...
    $sql1 = "SELECT * FROM rentedcameras rc, clientcameras cc, customers c, cameras WHERE cc.client_username = '$login_client' AND cc.camera_id = rc.camera_id AND rc.return_status = 'R' AND c.customer_username = rc.customer_username AND cc.camera_id = cameras.camera_id";
    ...
    ?>
        <div class="container">
            <div class="jumbotron">
                <h1 class="text-center">History Pemesanan</h1>
            </div>
        </div>
