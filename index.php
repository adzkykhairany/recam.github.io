...
<body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-8 col-md-offset-2">
                            <h1 class="brand-heading" style="color: black">RECAM</h1>
                            <p class="intro-text">
    ...
    <div id="sec2" style="color: #777;background-color:white;text-align:center;padding:50px 80px;text-align: justify;">
        ...
        <section class="menu-content">
            <?php
            $sql1 = "SELECT * FROM cameras WHERE camera_availability='yes'";
            $result1 = mysqli_query($conn, $sql1);

            if (mysqli_num_rows($result1) > 0) {
                while ($row1 = mysqli_fetch_assoc($result1)) {
                    $camera_id = $row1["camera_id"];
                    ...
                    $camera_img = $row1["camera_img"];
            ?>

                    <a href="booking.php?id=<?php echo ($camera_id) ?>">
                        <div class="sub-menu">
                            <img class="card-img-top" src="<?php echo $camera_img; ?>" alt="card image cap">
                            <h5><b> <?php echo $camera_name; ?> </b></h5>
                            <h6> Tipe: <?php echo $tipe_camera; ?> </h5>
                                <h6> Dengan lensa: <?php echo ("Rp." . $lensa_price_per_day . "/day"); ?></h6>
                                <h6> Tanpa lensa: <?php echo ("Rp. " . $tl_price_per_day . "/day"); ?></h6>
    ...
    <footer class="site-footer">
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-6">
                    <h5>© <?php echo date("Y"); ?> Camera Rentals</h5>
                </div>
